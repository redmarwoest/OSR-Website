...
const routes: Routes = [
  { path: '', pathMatch:'full', data: {depth: 1}, loadChildren: () => import( './pages/home/home.module').then(x => x.HomeModule)},
...
@NgModule({
  imports: [RouterModule.forRoot(routes,  {scrollPositionRestoration: 'enabled'}), BrowserAnimationsModule, ],
