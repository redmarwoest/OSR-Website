...
const sentences = [
  {
    picture: 'assets/form.svg',
    paragraph:
      'Neem contact op via de telefoon, email of vul het digital form in',
  },
  {
    picture: 'assets/time.svg',
    paragraph:
      'U ontvang vervolgens binnen 24 uur een vrijblijvend voorstel van ons',
  },
  {
    picture: 'assets/hand.svg',
    paragraph:
      'We sluiten samen de overeenkomst na het bereiken van een akkoord',
  },
];
...
const sentencesTwo = [
  ...
  {
    paragraphTwo:
      'Volledig begeleiding transparante werkwijze en vast aanspreekpunt',
  },
